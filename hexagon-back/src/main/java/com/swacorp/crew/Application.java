package com.swacorp.crew;

import com.swacorp.crew.adapter.driven.ApiRestPublisher;
import com.swacorp.crew.adapter.driven.PoemRepositoryAdapter;
...
public class Application {
	...
	@Bean
	public ApiRestDriver apiDriver() {
		PoemRepositoryAdapter poemObtainer = new PoemRepositoryAdapter(poemRepository);
		ApiRestPublisher apiRestPublisher = new ApiRestPublisher();
		Boundary boundary = new Boundary(poemObtainer, apiRestPublisher);
		ApiRestDriver apiDriver = new ApiRestDriver(boundary, apiRestPublisher);
		return apiDriver;
	}
